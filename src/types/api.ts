...
export interface paths {
    ...
    "/auth/public-key": {
        ...
        /**
         * Get Public Key
         * @description Returns the RSA public key for client-side encryption.
         */
    ...
    "/auth/logout": {
        ...
        /**
         * Logout
         * @description Logout the current user by incrementing their token_version.
    ...
    "/superadmin/users/{user_id}": {
        ...
        /**
         * Update User
         * @description Superadmin can update user details like name, mobile, username, or status.
         */
        put: operations["update_user_superadmin_users__user_id__put"];
        post?: never;
        /**
         * Delete User
         * @description Superadmin can hard-delete a user.
         *     Note: This will fail if the user has associated records (applications, etc.)
         *     due to foreign key constraints.
         */
        delete: operations["delete_user_superadmin_users__user_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/authority/vehicle-entries": {
         ...
         * @description Get all vehicle entries for authority view with advanced filtering.
         */
    ...
    "/api/applications/{application_id}/inspection": {
        ...
        /**
         * Update Inspection
         * @description JEN updates a site inspection report.
         */
        put: operations["update_inspection_api_applications__application_id__inspection_put"];
        /**
         * Create Inspection
    ...
    "/api/applications/{application_id}/phases/{phase}/status": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Update Phase Status
         * @description Nodal Officer or Superadmin can manually change a token's status.
         *     Used for: HOLD (WITHHELD), TERMINATE (TERMINATED), ACTIVATE (ACTIVE).
         */
        put: operations["update_phase_status_api_applications__application_id__phases__phase__status_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/master/wards/{ward_id}": {
        ...
        post?: never;
        /** Delete Ward */
        delete: operations["delete_ward_api_master_wards__ward_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/master/departments/{dept_id}": {
        ...
        post?: never;
        /** Delete Department */
        delete: operations["delete_department_api_master_departments__dept_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/master/roles/{role_id}": {
        ...
        post?: never;
        /** Delete Role */
        delete: operations["delete_role_api_master_roles__role_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/master/complaint-categories/{category_id}": {
        ...
        delete: operations["delete_complaint_category_api_master_complaint_categories__category_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/master/materials/{material_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /** Update Material */
        put: operations["update_material_api_master_materials__material_id__put"];
        post?: never;
        /** Delete Material */
        delete: operations["delete_material_api_master_materials__material_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/master/jens": {
        ...
        /**
         * List Jens
         * @description List all users with roles that can handle complaints/inspections (JEN, AEN, RIN, SIN).
         */
    ...
    "/api/complaints/{id}/resolve": {
        ...
        /**
         * Resolve Complaint
         * @description Resolve a complaint. Only assigned JEN, AEN, RIN, or SIN can resolve.
         */
...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        AuditAction: "CHANGED" | "CREATED" | "VIEWED" | "DELETED";
         ...
         * @description Grouped response for authority view of vehicle entries.
         */
        AuthorityVehicleEntryResponse: {
            /** Id */
            id: number;
            ...
            /** Materials */
            materials: components["schemas"]["VehicleEntryMaterialItem"][];
            /** Media */
            media?: {
                [key: string]: unknown;
            } | null;
        ...
        /** Body_resolve_complaint_api_complaints__id__resolve_post */
        Body_resolve_complaint_api_complaints__id__resolve_post: {
            /** Remarks */
            remarks?: string | null;
            /**
         ...
         * @description JEN updates an inspection report.
         */
        InspectionReportUpdate: {
            /**
             * Latitude
         ...
         * @description Request schema for updating a phase's status (Hold/Terminate/Activate).
         */
        PhaseStatusUpdateRequest: {
        ...
        TokenMaterialResponse: {
            ...
            remaining_quantity: number;
            /**
             * Permitted Material Quantity
             * @default 0
             */
            permitted_material_quantity: number;
            /**
             * Remaining Material Quantity
             * @default 0
             */
            remaining_material_quantity: number;
        };
        /** TokenResponse */
        TokenResponse: {
            /** Access Token */
        ...
        /**
         * VehicleEntryMaterialItem
         * @description Single material item within a vehicle entry.
         */
        VehicleEntryMaterialItem: {
            /** Id */
            id: number;
...
export interface operations {
    ...
    update_user_superadmin_users__user_id__put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_user_superadmin_users__user_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_all_vehicle_entries_api_authority_vehicle_entries_get: {
        parameters: {
            query?: {
                /** @description Fuzzy search by vehicle number, token number, material or date */
                search?: string | null;
                /** @description Filter by vehicle number(s) */
                vehicle_number?: string[] | null;
                /** @description Filter by material name(s) */
                material_name?: string[] | null;
                /** @description Filter by token number(s) */
                token_number?: string[] | null;
    ...
    update_inspection_api_applications__application_id__inspection_put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["InspectionReportUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    update_phase_status_api_applications__application_id__phases__phase__status_put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PhaseStatusUpdateRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    delete_ward_api_master_wards__ward_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_department_api_master_departments__dept_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_role_api_master_roles__role_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_complaint_category_api_master_complaint_categories__category_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_material_api_master_materials__material_id__put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_material_api_master_materials__material_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    resolve_complaint_api_complaints__id__resolve_post: {
        ...
        requestBody?: {
            content: {
                "multipart/form-data": components["schemas"]["Body_resolve_complaint_api_complaints__id__resolve_post"];
            };
        };
        responses: {
            /** @description Successful Response */
