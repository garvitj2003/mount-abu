...
export const destinations = [
  // --- A. TOP DESTINATIONS ---
  {
    ...
    description: "A stream of constantly flowing natural water through a cow's face statue, associated with ancient sages.",
    details: {
  ...
  },
  {
    ...
    description: "An ancient 5500-year-old temple dedicated to Goddess Durga, located inside a cave.",
    details: {
  ...
  },
  {
    ...
    description: "A 15th-century fort housing the Acheleshwar Mahadev Temple where Lord Shiva's thumb is worshipped.",
    details: {
  ...
  },
  {
    ...
    description: "World-famous collection of Jain temples known for their exquisite marble carvings.",
    details: {
    ...
    guidelines: {
      entryFee: "Free",
      timings: "Generally open morning and afternoon hours (varies seasonally)",
  ...
  },
  {
    ...
    description: "A 14th-century temple on the banks of Nakki Lake dedicated to Lord Vishnu's reincarnation.",
    details: {
  ...
  },
  {
    ...
    description: "A 450-year-old Shiva temple next to Nakki Lake with a legend involving a hunter and a deer.",
    details: {
  ...
  },
  {
    ...
    slug: "guru-shikhar",
    title: "Guru Shikhar",
    description: "The highest peak of the Aravalli Range, housing the temple of Dattatreya.",
    details: {
  ...
  },
  {
    ...
    slug: "nakki-lake",
    title: "Nakki Lake",
    description: "The first man-made lake in India, steeped in legends of gods and love stories.",
    details: {
  ...
  },
  {
    ...
    slug: "sunset-point",
    title: "Sunset Point",
    description: "A picturesque point offering stunning views of the setting sun over the Aravali hills.",
    details: {
  ...
  },
  {
    ...
    slug: "trevors-tank",
    title: "Trevor's Tank",
    description: "A man-made crocodile breeding site and wildlife sanctuary created by a British engineer.",
    details: {
  ...
  // --- B. UNEXPLORED GEMS ---
  {
    ...
    description: "A historical fire pit believed to be the origin of four main Agnikul Rajput clans.",
    details: {
  ...
  },
  {
    ...
    slug: "suraj-kund",
    title: "Suraj Kund",
    description: "A water-filled crater where the water appears golden at sunrise.",
    details: {
  ...
  },
  {
    ...
    slug: "chandra-kund",
    title: "Chandra Kund",
    description: "A natural water body where the moon's reflection is perfectly centered on full moon nights.",
    details: {
  ...
  },
  {
    ...
    slug: "kaner-kund",
    title: "Kaner Kund",
    description: "A historical kund surrounded by Kaner flowers, used by tribal people for rituals.",
    details: {
  ...
  },
  {
    ...
    slug: "moors-cave",
    title: "Moor’s Cave",
    description: "A hidden cave containing inscriptions by the missing British Officer Arthur Thomas Moore.",
    details: {
  ...
  },
  {
    ...
    slug: "mogli-land",
    title: "Mogli Land",
    description: "An area with ancient civilization remnants resembling the forest from The Jungle Book.",
    details: {
  ...
  // --- D. FUNCTIONAL CATEGORIES (Viewpoints, Heritage, Markets, Wildlife) ---
  {
    ...
    slug: "toad-rock",
    title: "Toad Rock",
    description: "A massive rock formation resembling a toad jumping into the water.",
    details: {
  ...
  },
  {
    ...
    slug: "nun-rock",
    title: "Nun Rock",
    description: "A rock simulating a veiled nun, though damaged by lightning in 1994.",
    details: {
  ...
  },
  {
    ...
    description: "A rich biodiversity hotspot in the Aravalli range home to leopards and sloth bears.",
    details: {
      ...
      images: {
        main: "/images/destination/mount-abu-wildlife-sanctuary/image_1.jpg",
        gallery: [
  ...
  },
  {
    ...
    description: "An eco-friendly heritage hotel built in 1870 by Maharaj Daivat Singh of Sirohi.",
    details: {
  ...
  },
  {
    ...
    description: "The primary commercial spine of the town, developed during the British period.",
    details: {
      ...
      images: {
        main: "/images/destination/mount-abu-main-bazaar/main.jpg",
        gallery: [
  ...
  },
  {
    ...
    description: "Popular shopping stop for winter wear and imported handicrafts.",
    details: {
      ...
      images: {
        main: "/images/destination/tibetan-market/image_1.jpg",
        gallery: [
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        description: "This trek passes through forest terrain with soft, leaf-covered soil, giving a spongy feel underfoot. It is best enjoyed during monsoon and winter and is suitable for beginners and nature walks.",
        images: { main: "", gallery: [] }
      }
    ]
  },
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        description: "A long forest route connecting Shergaon village to Rishikesh Temple through quiet jungle paths and rural terrain.",
        images: { main: "", gallery: [] }
      },
      {
...
export const unexploredGems = destinations.filter(d => d.id.startsWith("gem-"));
export const topDestinations = destinations.filter(d => d.id.startsWith("top-"));

// Functional categories (excluding Treks from here as they are now in trekGroups)
export const functionalCategories = {
  temples: destinations.filter(d => d.title.toLowerCase().includes("temple") || d.title.toLowerCase().includes("ashram")),
  viewpoints: destinations.filter(d => d.id.startsWith("view-") || d.id === "top-sunset-point" || d.title.includes("Point") || d.title.includes("Rock")),
  wildlife: destinations.filter(d => d.id.startsWith("wild-") || d.id === "top-trevors-tank"),
  heritage: destinations.filter(d => d.id.startsWith("her-") || d.id === "top-achalgarh"),
