...
const cardData: CardProps[] = [
  ...
  },
  {
    ...
    buttonText: "Download PDF",
    buttonVariant: "red",
    href: "https://drive.google.com/file/d/126xAU6Ly3U4eC1c_KehWHusyZKDehpBx/view?usp=drivesdk",
  },
  {
...
export default function InformationGuidlines() {
  return (
    <section
      id="info-guidelines"
      className="relative w-full min-h-screen overflow-hidden bg-[#132019]"
    >
