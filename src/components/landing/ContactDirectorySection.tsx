            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse">
                    <thead>
                        <tr>
                            {/* Header: Name */}
                            <th className="w-1/2 px-4 py-5 bg-[#d49d37] border-b border-white/10 border-r border-r-white/10">
                                <p className="font-montserrat font-medium text-sm md:text-base text-white text-center">
                                    Name
                                </p>
                            </th>
                            {/* Header: Post */}
                            <th className="w-1/2 px-4 py-5 bg-[#d49d37] border-b border-white/10">
                                <p className="font-montserrat font-medium text-sm md:text-base text-white text-center">
                                    Post
                                </p>
                            </th>
...
export default function ContactDirectorySection() {
    ...
    const handlePrev = () => {
        if (scrollContainerRef.current) {
            const cardWidth =
                scrollContainerRef.current.querySelector("div")?.clientWidth ||
                700;
    ...
    return (
        <section
            id="contact"
            className="relative w-full overflow-hidden min-h-screen flex items-center py-16 md:py-24"
        >
            {/* Background Image */}
