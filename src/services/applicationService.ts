...
export const ApplicationService = {
  ...
  async updateInspection(applicationId: number, data: components["schemas"]["InspectionReportUpdate"]): Promise<any> {
    const response = await api.put(`/api/applications/${applicationId}/inspection`, data);
    return response.data;
  },
};
